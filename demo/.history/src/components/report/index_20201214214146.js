 ...
 * @LastEditTime: 2020-12-14 21:41:22
...
class ReportComponent extends React.Component{
    ...
    handleReport(){
      const _this = this;
      this.setState({reportHight: 0})
      // var nowHight = _this.state.reportHight;
      // const arr = [];
      // arr.length = nowHight/100;
      // arr.forEach(item => {
      //   setTimeout(()=> {
      //     _this.setState({reportHight: nowHight-100});
      //   }, 500)
      // })
    }
        ...
        return (
            <>
                <div className="content">
                    ...
                    <div>
                        {/* echarts图 */}
                        <div ref="echarts" style={{ width: '100%', height: this.state.reportHight }} id="echarts"></div>
                    </div>
